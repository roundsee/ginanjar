...
<head>
  <meta charset="UTF-8">
  <title>Log in | <?php echo $perusahaan . " " . $naper1 . " " . $naper2; ?></title>
    ...
    <div id="wrapper" class="belakang">
      ...
      <div class="login-box">
        <div class="login-logo">
          <img src="<?php echo $dir; ?>images/logo2.png" height="50px" style="vertical-align:text-bottom;" class="list-gds wow fadeIn" data-wow-duration="1.5s" data-wow-delay="0.6s">
          <!-- <a href="index.php"><b><?php echo $naper1 . "</b> " . $naper2; ?></a> -->
          <h5>&nbsp;</h5>
        </div><!-- /.login-logo -->
        <div class="login-box-body belakang2 kotak" style="border-radius: 20px">
          <br>
          <p class="login-box-msg" style="font-weight:600; color: white;">Masuk | Login</p>

          <form action="cek_login.php?to=<?php echo $to; ?>&hash=<?php echo $hash; ?>" method="post">
            ...
            <div class="row">
              ...
              <div class="col-xs-4">
                <div class="login-box-msg">
                  <button type="submit" class="btn btn-primary btn-block pull-right tombol1" style="background-color: #0b5cb4; color: #ffffff; border: none;">
                    Login
                  </button>
