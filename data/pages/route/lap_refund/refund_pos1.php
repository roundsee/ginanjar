                  ...
                  <div class="box">
                    <div class="box-body">
                      ...
                      <div class="wrapper" style="min-height:30%">
                        <form role="form" action="route/<?php echo $data;?>/<?php echo $aksi;?>.php?route=<?php echo $rute;?>&act=report_refund_pos1" method="post">
                          <div class="row">
                            <!-- Batas -------------- -->
                                            ...
                                            <div class="table-responsive">
                                              <table class="table table-bordered table-striped table-hover" id="table-datatable-kasir">
                                                ...
                                                <tbody>
                                                  <?php 
                                                  $no=1;
                                                  $data = mysqli_query($koneksi,"SELECT employee_number,nama FROM employee WHERE id_jabatan=7 ORDER BY name_e ASC");
                                                  while($d = mysqli_fetch_array($data)){
                                                    ?>
                                                    <tr>
                                                      <td width="1%" class="text-center"><?php echo $no++; ?></td>
