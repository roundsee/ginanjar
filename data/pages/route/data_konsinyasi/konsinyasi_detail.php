...
$judulform = " Konsinyasi";

$data = 'data_konsinyasi';
$rute = 'konsinyasi';
$aksi = 'aksi_konsinyasi';

$rute_detail = 'konsinyasi_detail';
													...
													<section class="base">
														...
														<div class="row">
															...
															<div class="col-lg-4">
																<div class="form-group">
																	<label><?php echo $jj3; ?></label>
																	<input type="text" name="banyak_edit" class="form-control currency-input" data-format="currency" data-value="<?php echo $s1[$ff3] * $s1[$ff_31]; ?>" value="<?php echo number_format($s1[$ff3] * $s1[$ff_31], 0, ',', '.'); ?>" autofocus="">
																</div>
															</div>
