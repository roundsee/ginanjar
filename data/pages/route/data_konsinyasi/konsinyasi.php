...
$rute_detail2 = 'konsinyasi_tambah_invoice';
                    ...
                    <div class="box">
                      <div class="box-body">
                        <div class="table-responsive">
                          ...
                          <button class="btn btn-primary btn-sm elevation-2 " style="opacity: .7;" onclick="window.location='route/<?php echo $data; ?>/konsinyasi_tambah.php'"><i class="fa fa-plus" ;></i> Tambah</button>
                          ...
                          <form action="route/<?php echo $data; ?>/generate_purchase.php" method="post">
                            <table id="example1" class="table table-bordered table-striped">
                              ...
                              <tbody>
                                <?php
                                $sql1 = mysqli_query($koneksi, "SELECT * from $tabel WHERE kd_beli LIKE '%KONS-%' ORDER BY kd_beli");
                                $no = 1;
                                $nilai_pjk = 0;
                                $subtotal = 0;
                                ...
                                while ($s1 = mysqli_fetch_array($sql1)) {
                                  $sql2 = mysqli_query($koneksi, "SELECT *,sum(disc) as tot_disc, sum((jml*jumlah_pcs)*price) as tot_price, urut from $tabel2 WHERE kd_beli='$s1[kd_beli]' ");
                                  ...
                                  <tr align="left">
                                    ...
                                    <td>
                                      ...
                                      <?php if ($s1['status_invoice'] == 0) { ?>
                                        ...
                                        <a href="route/<?php echo $data; ?>/<?php echo $aksi; ?>.php?route=<?php echo $rute; ?>&act=hapus&id=<?php echo $s1[$f1]; ?>&id2=<?php echo $s2[$ff8]; ?>" title="Hapus" type="button" onclick="return confirm('Apakah anda yakin ingin menghapus ini ?')">
