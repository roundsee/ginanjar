...
if($id_jabatan==8){
  $sql=mysqli_query($koneksi,"SELECT * FROM employee WHERE employee_number='$en' ");
  $s1=mysqli_fetch_array($sql);
  $kode_area=$s1['area_e'];
  $kondisi_area=" kd_area=$kode_area ";
}else{
  $kode_area='';
  $kondisi_area="  ";
}
...
$data = 'lap_pb1';
$rute = 'pb1_strukprintulang';
$aksi = 'aksi_pb1_printulang';
                                        ...
                                        <form method="post" action="simpan_index.php">
                                          <div class="row">
                                            <div class="col-lg-6">
                                              ...
                                              <input type="text" class="form-control" required="required" id="tampil_kota_kode" placeholder="Isi Kota">
                                            </div>
                                            <div class="col-lg-6">
                                                ...
                                                <div class="table-responsive">
                                                  <table class="table table-bordered table-striped table-hover" id="table-datatable-kota">
                                                    ...
                                                    // $data = mysqli_query($koneksi, "SELECT kode,nama,kd_area FROM kotabaru ORDER BY kode ASC");
                                                      $data = mysqli_query($koneksi,"SELECT kode,nama,kd_area FROM kotabaru WHERE $kondisi_area ORDER BY kode ASC");
                                        ...
                                        <form method="post" action="simpan_index.php">
                                          <div class="row">
                                            <div class="col-lg-6">
                                              ...
                                              <input type="text" class="form-control" name="kd_outlet" required="required" id="tampil_outlet_kode" placeholder="Isi Outlet">
                                            </div>
                                            <div class="col-lg-6">
                                                ...
                                                <div class="table-responsive">
                                                  <table class="table table-bordered table-striped table-hover" id="table-datatable-outlet">
                                                    ...
                                                    // $data = mysqli_query($koneksi, "SELECT kd_cus,nama,kd_area FROM pelanggan ORDER BY kd_cus ASC");
                                                      $data = mysqli_query($koneksi,"SELECT kd_cus,nama,kd_area FROM pelanggan WHERE $kondisi_area ORDER BY kd_cus ASC");
                                                      while ($d = mysqli_fetch_array($data)) {
                                                        ?>
                                                        <tr>
                                                          <td width="1%" class="text-center"><?php echo $no++; ?></td>
        ...
        <section class="content-header  wow fadeInDown" data-wow-duration=".3s" data-wow-delay=".3s">
          <div class="container-fluid">
            ...
            <button class="btn btn-primary btn-sm elevation-2" style="opacity: .7;" onclick="window.open('route/<?php echo $data; ?>/cetak.php?tgl_awal=<?php echo $tgl_awal; ?>&tgl_akhir=<?php echo $tgl_akhir; ?>&filter=<?php echo $filter; ?>&nilai=<?php echo $nilai; ?>&judul=<?php echo $judul; ?>', '_blank');">
              <img src="../../assets/icons/print.png" width="20px"> print
            </button>
                  ...
                  <div class="box">
                    <div class="box-body">
                      <div class="table-responsive">
                        ...
                        <?php if ($login_hash == 6  or $filter == 'outlet') { ?>
                          <table id="example" class="table table-bordered table-striped">
                            ...
                            <tbody>
                              ...
                              WHERE (tanggal between '$tgl_awal' and '$tgl_akhir'  +interval 1 day) AND subjumlah <> 0 AND ppn <> 0 AND jumlah <> 0 $kondisi 
                              ";
                              ...
                              while ($s1 = mysqli_fetch_array($sql1)) {
                                ...
                                <tr align="left">
                                  ...
                                  <td align='center' width="100px;">
                                    <button type="button" onclick="navigateAndEditupdate(this)" class="btn btn-success"><i class="fa fa-print"></i><strong style="color: whitesmoke; opacity: .7;"> PRINT</strong></button>

                                  </td>
                                  <!-- <td align='center' width="100px;">
                                    <button type="button" onclick="navigateAndEditvoid(this)" class="btn btn-danger"><i class="fa fa-close"></i><strong style="color: whitesmoke; opacity: .7;"> VOID</strong></button> -->

                                  </td>
                                  <script>
                                    function navigateAndEditupdate(button) {


                                      var row = button.closest('tr');
                                      var tdValue = row.querySelector('td:nth-child(3)').textContent;

                                      localStorage.setItem('search_menu_value', tdValue);
                                      window.open(
                                        '../../kasir_steak/pages/main.php?route=kasir_print',
                                        '_blank'
                                        );
                                    }

                                    function navigateAndEditvoid(button) {
                                      var row = button.closest('tr');
                                      var tdValue = row.querySelector('td:nth-child(3)').textContent;

                                      localStorage.setItem('search_menu_value', tdValue);
                                      window.open(
                                        '../../void_trans/pages/main.php?route=kasir_void',
                                        '_blank'
                                        );
                                    }
                                  </script>
                        ...
                        <?php } elseif ($login_hash == 7  or $filter == 'outlet') { ?>
                          <table id="example" class="table table-bordered table-striped">
                            <thead style="background-color:  lightgray;font-size: 90%;" class="elevation-2">
                              <tr>
                                <th>No.</th>
                        ...
                        <?php } elseif ($login_hash == 8  or $filter == 'outlet') { ?>
                          <table id="example" class="table table-bordered table-striped">
                            <thead style="background-color:  lightgray;font-size: 90%;" class="elevation-2">
                              <tr>
                                <th>No.</th>
                            ...
                            <tbody>
                              ...
                              WHERE (tanggal between '$tgl_awal' and '$tgl_akhir'  +interval 1 day) AND subjumlah <> 0 AND ppn <> 0 AND jumlah <> 0 $kondisi AND pelanggan.kd_area=$kode_area
                              ";
                        ...
                        <?php } elseif ($login_hash == 8  or $filter == 'kota') { ?>
                          <table id="example" class="table table-bordered table-striped">
                            <thead style="background-color:  lightgray;font-size: 90%;" class="elevation-2">
                              <tr>
                                <th>No.kota</th>
