...
$act=$_GET['act'];
	...
	//Hapus area
if($route=='daftar_voucher' AND $act=='proses1')
{
...
}elseif($route=='daftar_voucher' AND $act=='proses2b')
{
...
elseif($route=='daftar_voucher' AND $act=='hapuskota')
{
...
elseif($route=='daftar_voucher' AND $act=='save')
{
...
elseif($route=='daftar_voucher' AND $act=='daftar_voucher_model2')
{
	$tujuan=$_GET['tujuan'];
	...
	header('location:../../route/lap_voucher/lap_daftar_voucher_model2.php?filter='.$filter.'&nilai='.$nilai.'&tgl_awal='.$tgl_awal.'&tgl_akhir='.$tgl_akhir.'&tujuan='.$tujuan);
