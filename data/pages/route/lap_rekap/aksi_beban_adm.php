...
$act=$_GET['act'];
	...
	//Hapus area
if($route=='beban_adm' AND $act=='proses1')
{
...
}elseif($route=='beban_adm' AND $act=='proses2b')
{
...
elseif($route=='beban_adm' AND $act=='hapuskota')
{
...
elseif($route=='beban_adm' AND $act=='save')
{
...
elseif($route=='beban_adm' AND $act=='report')
{
...
elseif($route=='beban_adm' AND $act=='lap_beban_adm_model2')
{
	$tujuan=$_GET['tujuan'];
	...
	// header('location:../../main.php?route='.$route.'&act=report&filter='.$filter.'&nilai='.$nilai.'&tgl_awal='.$tgl_awal.'&tgl_akhir='.$tgl_akhir);
	header('location:../../route/lap_rekap/lap_beban_adm_model2.php?filter='.$filter.'&nilai='.$nilai.'&tgl_awal='.$tgl_awal.'&tgl_akhir='.$tgl_akhir.'&tujuan='.$tujuan);

}
elseif($route=='beban_adm' AND $act=='rekap_beban_adm_model2')
{
	$tujuan=$_GET['tujuan'];
