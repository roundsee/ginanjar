...
<!-- <div class="container"> -->
		...
		<table style="background-color:beige;font-weight:700">
			<tr>
				...
				<td colspan="2" style="text-align:right;"><?php echo number_format($tot_subjumlah);?></td>
			</tr>
			<tr>
				<td colspan="3" > Total PB1</td>
				<td>:</td>
				<td colspan="2" style="text-align:right;"><?php echo number_format($tot_ppn);?></td>
			</tr>

			<tr>
				<td colspan="3"> Total setelah Pajak</td>
				<td>:</td>
				<td colspan="2" style="text-align:right;"><?php echo number_format($tot_jumlah);?></td>
			</tr>
