...
?>
                    ...
                    <div class="box-body">
                      ...
                      <div class="wrapper" style="min-height:30%">
                        <form role="form" action="route/<?php echo $data; ?>/<?php echo $aksi; ?>.php?route=<?php echo $rute; ?>&act=report&tujuan=<?php echo $tujuan; ?>" method="post">
                            ...
                            <div class="col-lg-2">
                              <?php if ($login_hash == 6 or $login_hash == 7 or $login_hash == 8) { ?>
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="date" class="form-control" name="tgl_awal" onclick="displayHasil(this.value)" placeholder="Masukkan Tanggal Awal .. (Wajib)" value="<?php echo date('Y-m-d') ?>" required="required" readonly>
                                </div>
                          ...
                          <?php if ($login_hash != '6' and $login_hash != '7' and $login_hash != '8') { ?>
    ...
    case "report";
      ...
      if ($tujuan == 'aplikasi') {
        ...
        $kondisi2 = 'Menu';
        $kondisi_group = ' ,daily_jualdetil.kd_brg';
      } else {
        $kondisi2 = '';
        $kondisi_group = '';
      }
      ...
      <div class="content-wrapper " style="background-color: beige;">
        ...
        <section class="content-header  wow fadeInDown" data-wow-duration=".3s" data-wow-delay=".3s">
          <div class="container-fluid">
            ...
            <button class="btn btn-primary btn-sm elevation-2" style="opacity: .7;" onclick="window.open('route/<?php echo $data; ?>/cetak.php?tgl_awal=<?php echo $tgl_awal; ?>&tgl_akhir=<?php echo $tgl_akhir; ?>&filter=<?php echo $filter; ?>&nilai=<?php echo $nilai; ?>&judul=<?php echo $judul; ?>', '_blank');">
              <img src="../../assets/icons/print.png" width="20px"> print </button>
                          ...
                          <div class="table-responsive">
                            ...
                            <table id="example" class="table table-bordered table-striped" style="width:600px">
                              ...
                              <tbody>
                                ...
                                $query = "SELECT 
                                      daily_penjualan.tarif_pb1 as penjualan_tarif_pb1,
                                      sum(daily_penjualan.jumlah) as rekap_jumlah, 
                                      sum(daily_penjualan.ppn) as rekap_ppn, 
                                      sum(daily_penjualan.byr_pocer) as rekap_pocer,
                                      sum(daily_penjualan.subjumlah) as rekap_subjumlah
                                      FROM daily_penjualan 
                                      join jenis_transaksi on jenis_transaksi.kd_jenis=daily_penjualan.kd_aplikasi 
                                      join alat_bayar on alat_bayar.kd_alat=daily_penjualan.kd_alatbayar 
                                      WHERE daily_penjualan.tanggal>='$tgl_awal' AND daily_penjualan.tanggal <= '$tgl_akhir' +interval 1 day AND daily_penjualan.kd_cus='$nilai'
                                      ";
                                ...
                                $query = "SELECT barang.nama as brg_nama, sum(daily_jualdetil.banyak) as rekap_jualdetil_banyak, sum(daily_jualdetil.jumlah) as rekap_jualdetil_jumlah 
                                      FROM daily_jualdetil 
                                      join pelanggan on pelanggan.kd_cus=daily_jualdetil.kd_cus 
                                      join barang on barang.kd_brg=daily_jualdetil.kd_brg 
                                      WHERE daily_jualdetil.tanggal>='$tgl_awal' AND daily_jualdetil.tanggal <= '$tgl_akhir' +interval 1 day AND daily_jualdetil.kd_cus='$nilai' GROUP By daily_jualdetil.kd_brg
                                      HAVING sum(daily_jualdetil.banyak) <> 0 AND sum(daily_jualdetil.jumlah) <> 0";
                              ...
                              <tfoot align="right">
                                ...
                                $query2 = "SELECT 
                                      sum(daily_penjualan.byr_tunai) as rekap_tunai
                                      FROM daily_penjualan 
                                      WHERE daily_penjualan.tanggal>='$tgl_awal' AND daily_penjualan.tanggal <= '$tgl_akhir' +interval 1 day AND daily_penjualan.kd_cus='$nilai' ";
                                ...
                                $query1 = "SELECT  
                                      ...
                                      daily_penjualan.kd_alatbayar as p_alat_bayar, 
                                      sum(daily_penjualan.byr_tunai) as rekap_tunai,
                                      sum(daily_penjualan.byr_non_tunai) as rekap_non_tunai
                                      FROM daily_penjualan
                                      join alat_bayar on alat_bayar.kd_alat=daily_penjualan.kd_alatbayar 
                                      WHERE daily_penjualan.tanggal>='$tgl_awal' AND daily_penjualan.tanggal <= '$tgl_akhir' +interval 1 day AND daily_penjualan.kd_cus='$nilai'
                            ...
                            <table id="example" class="table table-bordered table-striped" style="width:600px">
                              ...
                              <tbody>
                                ...
                                $query = "SELECT 
                                      ...
                                      sum(daily_penjualan.subjumlah) as rekap_subjumlah
                                      FROM daily_penjualan 
                                      join pelanggan on pelanggan.kd_cus=daily_penjualan.kd_cus
                                      join jenis_transaksi on jenis_transaksi.kd_jenis=daily_penjualan.kd_aplikasi 
                                      join alat_bayar on alat_bayar.kd_alat=daily_penjualan.kd_alatbayar 
                                      WHERE daily_penjualan.tanggal>='$tgl_awal' AND daily_penjualan.tanggal <= '$tgl_akhir' +interval 1 day  AND pelanggan.kd_kota='$nilai'
                                      ";
                                ...
                                $query = "SELECT barang.nama as brg_nama, sum(daily_jualdetil.banyak) as rekap_jualdetil_banyak, sum(daily_jualdetil.jumlah) as rekap_jualdetil_jumlah 
                                      ...
                                      join pelanggan on pelanggan.kd_cus=daily_jualdetil.kd_cus 
                                      join barang on barang.kd_brg=daily_jualdetil.kd_brg
                                      WHERE daily_jualdetil.tanggal>='$tgl_awal' AND daily_jualdetil.tanggal <= '$tgl_akhir' +interval 1 day AND pelanggan.kd_kota='$nilai' GROUP By daily_jualdetil.kd_brg
                                      ";
                            ...
                            <table id="example" class="table table-bordered table-striped" style="width:600px">
                              ...
                              <tbody>
                                ...
                                $query = "SELECT 
                                      ...
                                      join jenis_transaksi on jenis_transaksi.kd_jenis=daily_penjualan.kd_aplikasi 
                                      join alat_bayar on alat_bayar.kd_alat=daily_penjualan.kd_alatbayar 
                                      WHERE daily_penjualan.tanggal>='$tgl_awal' AND daily_penjualan.tanggal <= '$tgl_akhir' +interval 1 day AND pelanggan.kd_area='$nilai'
                                      ";
                                ...
                                $query = "SELECT barang.nama as brg_nama, sum(daily_jualdetil.banyak) as rekap_jualdetil_banyak, sum(daily_jualdetil.jumlah) as rekap_jualdetil_jumlah 
                                      ...
                                      join pelanggan on pelanggan.kd_cus=daily_jualdetil.kd_cus 
                                      join barang on barang.kd_brg=daily_jualdetil.kd_brg
                                      WHERE daily_jualdetil.tanggal>='$tgl_awal' AND daily_jualdetil.tanggal <= '$tgl_akhir' +interval 1 day AND pelanggan.kd_area='$nilai' GROUP By daily_jualdetil.kd_brg
                                      ";
                            ...
                            <table id="example" class="table table-bordered table-striped" style="width:600px">
                              ...
                              <tbody>
                                ...
                                $query = "SELECT 
                                      ...
                                      join jenis_transaksi on jenis_transaksi.kd_jenis=daily_penjualan.kd_aplikasi 
                                      join alat_bayar on alat_bayar.kd_alat=daily_penjualan.kd_alatbayar 
                                      WHERE daily_penjualan.tanggal>='$tgl_awal' AND daily_penjualan.tanggal <= '$tgl_akhir' +interval 1 day 
                                      ";
                                ...
                                $query = "SELECT barang.nama as brg_nama, 
                                      sum(daily_jualdetil.banyak) as rekap_jualdetil_banyak, 
                                      sum(daily_jualdetil.jumlah) as rekap_jualdetil_jumlah 
                                      FROM daily_jualdetil  
                                      join barang on barang.kd_brg=daily_jualdetil.kd_brg
                                      WHERE daily_jualdetil.tanggal>='$tgl_awal' AND daily_jualdetil.tanggal <= '$tgl_akhir' +interval 1 day  GROUP By daily_jualdetil.kd_brg";
