...
$act=$_GET['act'];
	...
	//Hapus area
if($route=='daftar_alat_bayar' AND $act=='proses1')
{
...
elseif($route=='daftar_alat_bayar' AND $act=='proses2b')
{
...
elseif($route=='daftar_alat_bayar' AND $act=='hapuskota')
{
...
elseif($route=='daftar_alat_bayar' AND $act=='save')
{
...
elseif($route=='daftar_alat_bayar' AND $act=='report')
{
	...
	// header('location:../../route/lap_daftar_alat_bayar/lap_1.php?filter='.$filter.'&nilai='.$nilai.'&tgl_awal='.$tgl_awal.'&tgl_akhir='.$tgl_akhir);

}
elseif($route=='daftar_alat_bayar' AND $act=='report_model2')
{
  ...
  $kd_alat=$_POST['kd_alat'];
	...
	header('location:../../route/lap_daftar_alat_bayar/lap_daftar_alat_bayar_model2.php?kd_alat='.$kd_alat);

}

elseif($route=='daftar_alat_bayar' AND $act=='edit')
{
	// $filter=$_GET['filter'];
	// $nilai=$_GET['nilai'];
	$kota=$_GET['kota'];
	...
	$query  = "UPDATE barang_kota SET harga = '$_POST[harga]' ";
	$query .= "WHERE jadi = '$_GET[id]' ";
	$result = mysqli_query($koneksi, $query);

	header('location:../../route/lap_daftar_alat_bayar/lap_daftar_alat_bayar_model2.php?kota='.$kota.'&kd_aplikasi='.$kd_aplikasi);
