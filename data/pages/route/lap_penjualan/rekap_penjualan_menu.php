                ...
                <div class="box">
                  <div class="box-body">
                    ...
                    <div class="wrapper" style="min-height:30%">
                      <form role="form" action="route/<?php echo $data;?>/<?php echo $aksi;?>.php?route=<?php echo $rute;?>&act=rekap_menu&tujuan=<?php echo $tujuan;?>" method="post">
                        <div class="row">
                          <!-- Batas -------------- -->
                          ...
                          <table id="example" class="table table-bordered table-striped">
                            <thead style="background-color:  lightgray;" class="elevation-2">
                              <tr>
                                ...
                                <?php if ($filter!='outlet' AND $filter!='area' AND $filter!='semua'){ ?>
                                  <th style="text-align:center;font-weight: 800;">Kode</th>
                                  <th style="text-align:center;font-weight: 800;">Outlet</th>
                                <?php } ?>

                                <?php if($filter!='kota' AND $filter!='outlet' AND $filter!='semua'){ ?>
                                  <th style="text-align:center;font-weight: 800;">Kode</th>
                                  <th style="text-align:center;font-weight: 800;">Kota</th>
                                <?php } ?>
                            ...
                            if($filter=='outlet'){
                             ...
                             $query="SELECT penjualan.kd_cus,
                             penjualan.tarif_pb1,pelanggan.kd_kota,
                             ...
                             GROUP by penjualan.kd_cus,jualdetil.kd_brg
                             order by barang.kd_brg asc
                             ";
                           }elseif($filter=='kota'){
                              $query="SELECT penjualan.kd_cus, penjualan.tarif_pb1, 
                              pelanggan.nama as p_nama,
                              kotabaru.nama as kb_nama ,
                              penjualan.kd_aplikasi as ka_kode, 
                              jualdetil.kd_brg as jd_kd_brg,
                             ...
                             $query="SELECT penjualan.tarif_pb1,pelanggan.kd_kota, 
                             pelanggan.nama as p_nama,
                             kotabaru.nama as kb_nama ,
                             penjualan.kd_aplikasi as ka_kode, 
                             jualdetil.kd_brg as jd_kd_brg,
                             ...
                             $query="SELECT  penjualan.tarif_pb1,
                             pelanggan.nama as p_nama,
                             kotabaru.nama as kb_nama ,
                             penjualan.kd_aplikasi as ka_kode, 
                             jualdetil.kd_brg as jd_kd_brg,
                           ...
                           while($s1=mysqli_fetch_array($sql1))
                           {
                            ...
                            <tr align="left">
                              ...
                              <td style="text-align: right;"><?php echo format_rupiah($s1['rekap_jualdetil_banyak']);?></td>
                              <td style="text-align: right;"><?php echo format_rupiah($total_stlh_pajak);?></td>
