                      ...
                      <div class="table-responsive">
                        ...
                        <table id="example" class="table table-bordered table-striped">
                           ...
                           while($ll1=mysqli_fetch_array($l1))
                          {
                           ...
                           // $voucher="SELECT sum(rekap_pocer) as total_voucher , p_nama FROM penjualan_alatbayar";
                           // $v=mysqli_fetch_array(mysqli_query($koneksi,$voucher));
                           // $tot_voucher=$v['total_voucher'];

                           // $tunai="SELECT sum(rekap_tunai) as total_tunai , p_nama FROM penjualan_alatbayar";
                           // $t=mysqli_fetch_array(mysqli_query($koneksi,$tunai));

                           // $tot_tunai=$t['total_tunai'];
                           // $nama_outlet=$t['p_nama'];


                           $query="SELECT * FROM penjualan_alatbayar WHERE p_nama='$loop1_nama' AND sab_nama!='TUNAI' " ;
                           ...
                           <tr align="left">
                            <td><?php echo $no++; ?></td>
                            <td><?php echo $loop1_nama; ?></td>
                            <td>Tunai</td>
                            <td style="text-align:right;"><?php echo format_rupiah($loop1_tunai); ?></td>
                          </tr>
                          <tr align="left">
                            <td><?php echo $no++; ?></td>
                            <td><?php echo $loop1_nama; ?></td>
                            <td>Voucher</td>
                            <td style="text-align:right;"><?php echo format_rupiah($loop1_voucher); ?></td>
                          </tr>
                          ...
                          while($s1=mysqli_fetch_array($sql1))
                          {
                            ...
                            //     <td>Tunai</td>
                            //     <td style="text-align:right;"><?php echo format_rupiah($tot_tunai); ?></td>
                            //   </tr>
                            //   <tr align="left">
                            //     <td><?php echo $no++; ?></td>
                            //     <td><?php echo $nama_outlet; ?></td>
                            //     <td>Voucher</td>
                            //     <td style="text-align:right;"><?php echo format_rupiah($tot_voucher); ?></td>
                            //   </tr>
