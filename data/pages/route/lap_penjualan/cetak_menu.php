		...
		<table id="example" border="1" class="table table-bordered table-striped">
			<thead style="background-color:  lightgray;" class="elevation-2">
				<tr>
					...
					<th style="width:100px;font-weight: 800;">Kode</th>
					<th style="font-weight: 800;">Nama</th>
					<th width="20px" style="text-align: right;font-weight: 800;">Banyak</th>
					<th width="20px" style="text-align: right;font-weight: 800;">Jumlah</th>
			...
			<tbody>
				...
				while($s1=mysqli_fetch_array($sql1))
				{
					...
					<tr align="left">
						...
						<td style="width:160px;text-align: center;"><?php echo $s1['jd_kd_brg']; ?></td>
