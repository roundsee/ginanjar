                    ...
                    <div class="box">
                      <div class="box-body">
                        <div class="table-responsive">
                          ...
                          $query="SELECT  pelanggan.nama as p_nama,kotabaru.nama as kb_nama ,jenis_transaksi.nama as jt_nama,alat_bayar.nama as ab_nama,subalat_bayar.nama as sab_nama,penjualan.kd_aplikasi as ka_kode,penjualan.kd_alatbayar as kd_alatbayar,penjualan.kdsub_alatbayar as kdsub_alatbayar,
                          ...
                          while($s1=mysqli_fetch_array($sql1))
                          {
                            ...
                            $rekap_jumlah[]=$s1['rekap_jumlah'];
                            $rekap_tunai[]=0;
                            $rekap_non_tunai[]=$s1['rekap_pocer'];
                            $rekap_pocer[]=$s1['rekap_pocer'];
                            }
                          ...
                          <table id="example1" class="table table-bordered table-striped">
                            <thead style="background-color:  lightgray;" class="elevation-2">
                              <tr>
                                ...
                                <th style="width: 200px;text-align: right;">Pembayaran</th>
                           ...
                           // Loop PERTAMA
                             $loop1="SELECT p_nama, sum(rekap_tunai) as total_tunai , sum(rekap_pocer) as total_pocer,kd_alatbayar,kdsub_alatbayar FROM `penjualan_alatbayar` group by p_nama";
                             ...
                             // $no=1;
                              ...
                              while($s1=mysqli_fetch_array($sql1))
                              {
                                ...
                                <tr align="left">
                                  ...
                                  <td><?php echo $s1['kd_alatbayar']; ?></td>
