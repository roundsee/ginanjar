...
$act=$_GET['act'];
	...
	//Hapus area
if($route=='rekap' AND $act=='proses1')
{
...
}elseif($route=='rekap' AND $act=='proses2b')
{
...
elseif($route=='rekap' AND $act=='hapuskota')
{
...
elseif($route=='rekap' AND $act=='save')
{
...
elseif($route=='rek' AND $act=='report')
{
...
elseif($route=='rekap_penjualan_menu_outlet' AND $act=='report')
{
	$tujuan=$_GET['tujuan'];
	...
	// header('location:../../route/lap_rekap/lap_rekap_penjualan_model2.php?filter='.$filter.'&nilai='.$nilai.'&tgl_awal='.$tgl_awal.'&tgl_akhir='.$tgl_akhir.'&tujuan='.$tujuan);

}
elseif($route=='rekap_penjualan_menu_outlet' AND $act=='rekap_menu')
{
	$tujuan=$_GET['tujuan'];
	...
	header('location:../../main.php?route='.$route.'&act=report&filter='.$filter.'&nilai='.$nilai.'&tgl_awal='.$tgl_awal.'&tgl_akhir='.$tgl_akhir.'&tujuan='.$tujuan);
	// header('location:../../route/lap_rekap/lap_rekap_penjualan_menu_model2.php?filter='.$filter.'&nilai='.$nilai.'&tgl_awal='.$tgl_awal.'&tgl_akhir='.$tgl_akhir.'&tujuan='.$tujuan);
