...
?>
                        ...
                        <div class="table-responsive">
                          ...
                          <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                              ...
                              $query = mysqli_query($koneksi, "SELECT * FROM kategori_satuan");
                              ...
                              ?>
                                <tr align="middle">
                                  ...
                                  <td><?php echo $j[$f5]; ?> </td>
                                  <td><?php echo $j[$f6]; ?> </td>
                                  <td><a href="main.php?route=kategori_satuan&act=edit&ids=<?php echo $j[$f1]; ?>&asal=<?php echo $_GET['asal']; ?>" title="Edit Data"><button class="btn btn-primary btn-sm elevation-2" style="opacity: .7;width:80px"><i class="fa fa-edit"></i> Edit</button></a>

                                    <a href="route/data_kategori_satuan/aksi_kategori_satuan.php?route=kategori_satuan&act=hapus&id=<?php echo $j[$f1]; ?>" title="Hapus Data" onclick="return confirm('Apakah anda yakin ingin menghapus ini ?')"><button class="btn btn-danger btn-sm elevation-2" style="opacity: .7;width:80px"><i class="fa fa-trash"></i> Hapus</button></a>
                                  </td>
                                </tr>
                              <?php
                              }
    ...
    case "edit":
      ...
      //edit
      $ubah = mysqli_query($koneksi, "SELECT * FROM kategori_satuan WHERE id_kat_satuan  = '$_GET[ids]'");
                        ...
                        <form method="POST" action="route/<?php echo $data; ?>/<?php echo $aksi; ?>.php?route=<?php echo $rute; ?>&act=edit&ids=<?php echo $u[$f1]; ?>" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                            ...
                            <select id="<?php echo $f2; ?>" name="<?php echo $f2; ?>" class="form-control" value="<?php echo $u[$f2]; ?>">
                              <option value="<?php echo $u[$f2]; ?>"><?php echo $u[$f2]; ?></option>
                          ...
                          <div class="form-group">
                            ...
                            <select id="<?php echo $f3; ?>" name="<?php echo $f3; ?>" class="form-control" value="<?php echo $u[$f3]; ?>">
                              <option value="<?php echo $u[$f3]; ?>"><?php echo $u[$f3]; ?></option>
                              <option value="hrg_pcs">Pcs</option>
                              <option value="hrg_renteng">Renteng</option>
                              <option value="hrg_pak">Pak</option>
                              <option value="hrg_ikat">ikat</option>
                          ...
                          <div class="form-group">
                            ...
                            <select id="<?php echo $f4; ?>" name="<?php echo $f4; ?>" class="form-control" value="<?php echo $u[$f4]; ?>">
                              <option value="<?php echo $u[$f4]; ?>"><?php echo $u[$f4]; ?></option>
                              <option value="hrg_pcs">Pcs</option>
                              <option value="hrg_renteng">Renteng</option>
                              <option value="hrg_pak">Pak</option>
                              <option value="hrg_ikat">ikat</option>
                          ...
                          <div class="form-group">
                            ...
                            <select id="<?php echo $f5; ?>" name="<?php echo $f5; ?>" class="form-control" value="<?php echo $u[$f5]; ?>">
                              <option value="<?php echo $u[$f5]; ?>"><?php echo $u[$f5]; ?></option>
                              <option value="hrg_pcs">Pcs</option>
                              <option value="hrg_renteng">Renteng</option>
                              <option value="hrg_pak">Pak</option>
                              <option value="hrg_ikat">ikat</option>
                          ...
                          <div class="form-group">
                            ...
                            <select id="<?php echo $f6; ?>" name="<?php echo $f6; ?>" class="form-control" value="<?php echo $u[$f6]; ?>">
                              <option value="<?php echo $u[$f6]; ?>"><?php echo $u[$f6]; ?></option>
                              <option value="hrg_pcs">Pcs</option>
                              <option value="hrg_renteng">Renteng</option>
                              <option value="hrg_pak">Pak</option>
                              <option value="hrg_ikat">ikat</option>
