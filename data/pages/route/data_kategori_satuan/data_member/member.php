...
?>
                            ...
                            <tbody>
                              ...
                              ?>
                                <tr align="left">
                                  ...
                                  <td><?php echo $j[$f8]; ?></td>
                                  <td><?php echo $j[$f9]; ?></td>
                                  <td><a href="main.php?route=member&act=edit&ids=<?php echo $j[$f2]; ?>&asal=<?php echo $_GET['asal']; ?>" title="Edit Data"><button class="btn btn-primary btn-sm elevation-2" style="opacity: .7;width:80px"><i class="fa fa-edit"></i> Edit</button></a>

                                    <a href="route/data_member/aksi_member.php?route=member&act=hapus&id=<?php echo $j[$f2]; ?>" title="Hapus Data" onclick="return confirm('Apakah anda yakin ingin menghapus ini ?')"><button class="btn btn-danger btn-sm elevation-2" style="opacity: .7;width:80px"><i class="fa fa-trash"></i> Hapus</button></a>
                                  </td>
                                </tr>
                              <?php
                                $no++;
    ...
    case "edit":
      ...
      //edit
      $ubah = mysqli_query($koneksi, "SELECT * FROM member WHERE kd_member = '$_GET[ids]'");
