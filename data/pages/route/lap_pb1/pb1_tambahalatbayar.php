        ...
        <div class="content-wrapper" style="background-color: beige; max-height: 1400px!important;">
          ...
          <section class="content-header  wow fadeInDown" data-wow-duration=".3s" data-wow-delay=".3s" >
            <div class="container-fluid">
              ...
              <!-- <button class="btn btn-primary btn-sm elevation-2 " style="opacity: .7;" onclick="window.location='route/<?php echo $data;?>/lap_pb1_excel.php?tgl_awal=<?php echo $tgl_awal;?>&tgl_akhir=<?php echo $tgl_akhir;?>&filter=<?php echo $filter;?>&nilai=<?php echo $nilai;?>&judul=<?php echo $judul;?>'"><img src="../../assets/icons/excel2.png" width="20px"> export +10% </button> -->
                          ...
                          <?php }elseif($filter=='kota'){ ?>
                            ...
                            <table id="example" class="table table-bordered table-striped">
                              ...
                              <tbody>
                               ...
                               sum(penjualan.subjumlah) as p_subjumlah, sum(penjualan.ppn) as p_ppn, sum(penjualan.jumlah) as p_jumlah, pelanggan.nama as p_nama, kotabaru.nama as kb_nama FROM penjualan join pelanggan on pelanggan.kd_cus=penjualan.kd_cus join kotabaru on kotabaru.kode=pelanggan.kd_kota WHERE (tanggal between '$tgl_awal' and '$tgl_akhir' +interval 1 day) AND pelanggan.kd_kota='$nilai' GROUP BY pelanggan.nama ";
                        ...
                        <?php }elseif($filter=='area'){ ?>
                            ...
                            <table id="example" class="table table-bordered table-striped">
                              ...
                              <tbody>
                               ...
                               $query="SELECT count(penjualan.faktur) as p_faktur,
                               sum(penjualan.subjumlah) as p_subjumlah, sum(penjualan.ppn) as p_ppn, sum(penjualan.jumlah) as p_jumlah, kotabaru.nama as kb_nama FROM penjualan join pelanggan on pelanggan.kd_cus=penjualan.kd_cus join kotabaru on kotabaru.kode=pelanggan.kd_kota WHERE (tanggal between '$tgl_awal' and '$tgl_akhir' +interval 1 day) AND kotabaru.kd_area='$nilai' GROUP BY kotabaru.nama ";
                        ...
                        <?php }elseif($filter=='semua'){ ?>
                            ...
                            <table id="example" class="table table-bordered table-striped">
                              ...
                              <tbody>
                               ...
                               $query="SELECT count(penjualan.faktur) as p_faktur,
                               sum(penjualan.subjumlah) as p_subjumlah, sum(penjualan.ppn) as p_ppn, sum(penjualan.jumlah) as p_jumlah, area.nama as a_nama  FROM penjualan join pelanggan on pelanggan.kd_cus=penjualan.kd_cus join kotabaru on kotabaru.kode=pelanggan.kd_kota join area on area.kode=pelanggan.kd_area WHERE (tanggal between '$tgl_awal' and '$tgl_akhir' +interval 1 day)  GROUP BY area.nama ";
