...
?>
                            ...
                            <tbody>
                              ...
                              ?>
                                <tr align="left">
                                  ...
                                  <td><?php echo $j[$f5]; ?></td>
                                  <td><?php echo $j[$f6]; ?></td>
                                  <td><a href="main.php?route=pembelian&act=edit&ids=<?php echo $j[$f2]; ?>&asal=<?php echo $_GET['asal']; ?>" title="Edit Data"><button class="btn btn-primary btn-sm elevation-2" style="opacity: .7;width:80px"><i class="fa fa-edit"></i> Edit</button></a>

                                    <a href="route/data_pembelian/aksi_pembelian.php?route=pembelian&act=hapus&id=<?php echo $j[$f2]; ?>" title="Hapus Data" onclick="return confirm('Apakah anda yakin ingin menghapus ini ?')"><button class="btn btn-danger btn-sm elevation-2" style="opacity: .7;width:80px"><i class="fa fa-trash"></i> Hapus</button></a>
                                  </td>
                                </tr>
                              <?php
                                $no++;
    ...
    case "edit":
      ...
      //edit
      $ubah = mysqli_query($koneksi, "SELECT * FROM pembelian WHERE kd_beli = '$_GET[ids]'");
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="box box-warning">
                      <div class="box-body">
                        ...
                        <form method="POST" action="route/<?php echo $data; ?>/<?php echo $aksi; ?>.php?route=<?php echo $rute; ?>&act=edit&ids=<?php echo $u[$f2]; ?>" enctype="multipart/form-data">
                          <!-- text input -->
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" name="<?php echo $f2; ?>" class="form-control" value="<?php echo $u[$f2]; ?>" required="required" />
                          </div>
