                        ...
                        <div class="table-responsive">
                          ...
                          <form action="route/<?php echo $data; ?>/generate_purchase.php" method="post">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                              ...
                              <tbody>
                                <?php
                                $sql1 = mysqli_query($koneksi, "SELECT * from $tabel WHERE kd_beli NOT LIKE '%KONS-%'");
                                $no = 1;
                                $nilai_pjk = 0;
                                $subtotal = 0;
                                  ...
                                  <tr align="left">
                                    ...
                                    <!-- <td style="color: blue;">
                                      <button type="button" class="btn btn-link p-0" style="text-decoration: none; color: inherit;"
                                        data-toggle="modal" data-target="#viewModal" data-kd_beli="<?php echo $s1['kd_beli']; ?>">
                                        <?php echo $s1[$f1]; ?>
                                      </button>
                                    </td> -->
                                    ...
                                    <!-- <td>
                                    <?php if ($s1[$f8] == 0) { ?>
                                      <button class="btn btn-success btn-sm" style="opacity: .9; width: 140px;" disabled>
                                        <i class="fa fa-circle"></i> Wait
                                      </button>
                                    <?php } elseif ($s1[$f8] == 1) { ?>
                                      <button class="btn btn-danger btn-sm" style="opacity: .5; width: 140px;" disabled>
                                        <i class="fa fa-clock-o"></i> CANCEL
                                      </button>
                                    <?php } elseif ($s1[$f8] == 2) { ?>
                                      <button class="btn-secondary btn-sm" style="opacity: .5;width:140px" disabled><i class="fa fa-clock-o"></i> Approve</button></a>
                                    <?php } ?>
                                  </td> -->
                                    ...
                                    <td>
                                      <!-- <button type="button" class="btn btn-info btn-sm elevation-2" style="opacity: .7; width:80px;" data-toggle="modal" data-target="#viewModal" data-kd_beli="<?php echo $s1['kd_beli']; ?>">
                                        View
                                      </button> -->
                                      <?php if ($s1[$f8] == 0) { ?>
