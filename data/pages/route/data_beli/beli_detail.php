												...
												<div class="row">
													...
													<div class="col-lg-3" style="background-color:ghostwhite;">
														<div class="form-group">
															...
															<input type="number" name="<?php echo $f13; ?>" value="<?php echo $term_of_payment; ?>" class="form-control" rows="2" cols="50"><?php echo $q1[$f4]; ?>
														</div>
													</div>
												...
												<script>
													...
													document.getElementById('addFormButton').addEventListener('click', function() {
														...
														var newFormFieldsHtml = `
																<div class="row border-bottom">
																	...
																	<div class="col-lg-2">
																		<div class="form-group">
																			<label>Harga</label>
																			<input type="text" name="harga[]"  data-format = "currency" class="form-control harga-input" placeholder="Masukan Harga" required>
																		</div>
																	</div>
																    <div class="col-lg-2">
																		<div class="form-group">
														...
														$(newFormElement).find('select[name="kd_acc2[]"]').on('change', function() {
															...
															$.ajax({
																url: './route/data_beli/get_harga_barang.php', // Pastikan ini sesuai dengan nama file Anda
																type: 'POST',
																data: {
