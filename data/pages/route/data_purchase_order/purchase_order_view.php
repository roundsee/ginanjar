                                                        ...
                                                        <div class="row">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="" class="form-control" value="<?php echo $kd_po; ?>" readonly />
                                                                        </div>
                                                                    </div>

                                                                    <input type="hidden" name="<?php echo $f1; ?>" class="form-control" value="<?php echo $id; ?>" readonly />


                                                                    <div class="col-lg-4">
                                                                        <div class="form-group">
                                                                            <label>Nama Supplier</label>
                                                                            <select name="<?php echo $f3; ?>" id="kd_supp_select" class="form-control">
                                                                    ...
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                            <label>PPN</label>
                                                                            <select name="ppn" id="pilihan" class="form-control">
                                                                                <?php
                                                                                $pilihan_ppn = [
                                                                                    '0' => 'Non PPN',
                                                                                    '1' => 'PPN'
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        ...
                                                                        <select class="form-control" name="<?= $f15; ?>" id="">
                                                            ...
                                                            <div class="col-lg-5">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="number" name="<?php echo $f13; ?>" rows="6" cols="70" class="form-control" value="<?php echo $term_of_payment; ?>">
                                                                </div>
                                                            </div> <!-- col-lg-5  -->
                                                            <!-- <div class="col-lg-2">
                                                                <div class="form-group">
                                                ...
                                                <table id="example1" width="100%" border="1" cellspacing="0" cellpadding="0" class="table table-bordered table-striped">
                                                    <thead style="background-color: #ddd;">
                                                        <tr style="font-weight:600">
                                                            ...
                                                            <td>Nama Barang</td>
                                                            <td align="left" width="100px"><?php echo $jj3; ?></td>
                                                            <td align="center" width="100px">Satuan</td>
                                                            <td align="left" width="100px"><?php echo $jj4; ?></td>
        ...
        ?>
                                                    ...
                                                    <section class="base">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-2">
                                                                <div class="form-group">
                                                                    <label>Satuan</label>
                                                                    <input type="text" name="" class="form-control" value="Pcs" readonly />
                                                                </div>
                                                            </div>
                                                        </div>
                                                         ...
                                                         <div class="row">
															<div class="col-lg-4">
																<div class="form-group">
																	<label><?php echo $jj3; ?></label>
																	<input type="text" name="<?php echo $ff3; ?>" class="form-control currency-input" data-format="currency" data-value="<?php echo $s1[$ff3] * $s1[$ff_31]; ?>" value="<?php echo number_format($s1[$ff3] * $s1[$ff_31], 0, ',', '.'); ?>" autofocus="">
																</div>
															</div>
															...
															<div class="col-lg-2">
																<div class="form-group">
																	...
																	<input type="text" name="<?php echo $ff4; ?>" class="form-control currency-input" data-format="currency" data-value="<?php echo $s1[$ff4]; ?>" value="<?php echo number_format($s1[$ff4], 0, ',', '.'); ?>" autofocus="">
																</div>
															</div>
            ...
            <script>
                ...
                function formatCurrency(inputElement) {
                    ...
                    // Simpan nilai numerik asli di data-value
                    ...
                    // Tampilkan angka dalam format Rupiah tanpa "Rp"
                ...
                document.querySelector('form').addEventListener('submit', function(e) {
                    document.querySelectorAll('[data-format="currency"]').forEach(input => {
                        // Set nilai input ke nilai numerik asli dari data-value
