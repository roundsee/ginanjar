                                                        ...
                                                        <table id="example1" class="table table-bordered table-striped">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                while ($s1 = mysqli_fetch_array($sql1)) {
                                                                    $sql2 = mysqli_query($koneksi, "SELECT *,sum(disc) as tot_disc, sum(jml*price) as tot_price , sum(jml) as jumlah_pcs  from $tabel2 WHERE kd_beli='$s1[kd_beli]' ");
                                                                ...
                                                                ?>
                                                                    <tr align="left">
                                                                        ...
                                                                        <td style="text-align:right;"><?php echo $jumlah_pcs; ?></td>
