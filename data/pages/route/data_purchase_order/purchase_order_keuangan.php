...
$judulform = "Purchase Order Keuangan";
                                            ...
                                            <div class="box-body">
                                                <div class="table-responsive">
                                                    ...
                                                    <?php if ($login_hash != 21) { ?>
                                                        ...
                                                        WHERE status_pembelian = 4  AND  $tabel.kd_beli NOT LIKE '%KONS-%'
                                                        GROUP BY kd_po");
                                                                ...
                                                                while ($s1 = mysqli_fetch_array($sql1)) {
                                                                    $sql2 = mysqli_query($koneksi, "
                                                                        ...
                                                                        (SELECT SUM($tabel2.jml * $tabel2.jumlah_pcs *  $tabel2.price) FROM $tabel2 WHERE $tabel2.kd_beli = '{$s1['kd_beli']}')  AS tot_price,
