...
?>
        ...
        display: none;
            ...
            <div class="content-wrapper" style="height:70%">
                                                ...
                                                <div class="row" style="background-color:ghostwhite;">
                                                    ...
                                                    <form method="POST" action="route/<?php echo $data; ?>/<?php echo $aksi; ?>.php?route=<?php echo $rute; ?>&act=edit&id=<?php echo $q1[$f1]; ?>">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <!-- <div class="col-lg-2">
                                                                    <div class="form-group">
                                                                        <label for=""><?php echo $f17 ?></label>
                                                                        <input type="number" name="<?= $f17; ?>" value="<?= $q1[$f17] ?? ''; ?>">
                                                                    </div>
                                                                </div> -->
                                                            ...
                                                            <div class="col-lg-5">
                                                                <div class="form-group">
                                                                    <label>Total tagihan yang harus dibayarkan (Sesuai PO)<sup style="color: red;"></sup></label>
                                                                    <input type="text" id="ttg" name="" class="form-control" value="<?php echo $stotal; ?>" readonly>
                                                                </div>
                                                            </div> <!-- col-lg-5 -->
                                                        </div> <!-- row -->
                                                        ...
                                                        <table id="example1" width="100%" border="1" cellspacing="0" cellpadding="0" class="table table-bordered table-striped">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                (SELECT pb.jumlah_datang
                                                                    ...
                                                                    WHERE pb.kd_po = pd.kd_po AND pb.kd_brg = pd.kd_brg
                                                                ...
                                                                ?>
                                                                    <tr>
                                                                        ...
                                                                        <td align="right">
                                                                            <input type="text" name="jumlah[<?php echo $no; ?>]" value="<?php echo $s1['jml'] * $s1['jumlah_pcs']; ?>" class="form-control" readonly>
                                                                        </td>
                                                                        <td>PCS</td>
                                                                        <td align="right">
                                                                        ...
                                                                        <td align="right">
                                                                            <input type="text" name="subTotal[<?php echo $no; ?>]" value="<?php echo number_format($total_harga); ?>" class="form-control" readonly>
                                                                        </td>
                                                                        <td align="right">
                                                            ...
                                                            <tfoot>
                                                                <tr style="font-weight:600">
                                                                    ...
                                                                    <td align="left" id="stotal"><?php echo number_format($stotal); ?></td>
                                                                    <td></td>
                                                                </tr>
                                                            </tfoot>
                                                        </table>
                ...
                document.addEventListener('DOMContentLoaded', function() {
                    // Ambil nilai dari elemen dengan id 'stotal'
                    let subtotalText = document.getElementById('stotal').textContent.trim();

                    // Hilangkan koma (,) dari format number_format PHP
                    ...
                    // Tampilkan nilai ke dalam input "Total Tagihan"
                    // document.getElementById('ttg').value = subtotalValue.toFixed(2); // Membulatkan ke 2 desimal
                    ...
                    // Set nilai ke input dengan format Rupiah
