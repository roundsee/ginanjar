...
// session_start();
$login_hash = $_SESSION['login_hash'] ?? 0;
?>
<!DOCTYPE html>
      ...
      <div class="container" style="margin:0;font-size: smaller;">
        ...
        <div class="collapse navbar-collapse order-3" id="navbarCollapse">
          ...
          <ul class="navbar-nav" style="font-weight:200;">
            ...
            <li class="nav-item">
              <a href="javascript:history.back()" class="nav-link warna_primary_2">
                <img src="../../../../assets/icons/rotate-left-solid-w.png" width="25px"> Back
              </a>
            </li>

            <?php if ($login_hash == 21210) { ?>
              ...
              <li class="nav-item dropdown">
                <a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link warna_primary_2 dropdown-toggle">
                  <i class="fa fa-clipboard"></i> SYSADMIN</a>

                <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow" style="left: 0px; right: inherit;">

                  <li><a href="main.php?route=test_daily_penjualan&act&ide=<?php echo $_SESSION['employee_number']; ?>&asal=test1&tujuan=" class="dropdown-item">Test Daily Penjualan</a></li>
                  <li><a href="main.php?route=test_daily_penjualan_detil&act&ide=<?php echo $_SESSION['employee_number']; ?>&asal=test1&tujuan=" class="dropdown-item">Test Daily Penjualan detil</a></li>
