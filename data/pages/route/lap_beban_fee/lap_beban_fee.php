                    ...
                    <div class="box-body">
                      <div class="table-responsive">
                        ...
                        <table id="example" class="table table-bordered table-striped">
                          <thead style="background-color:  lightgray;font-size:95% ;" class="elevation-2">
                            <tr>
                          ...
                          <tbody>
                           ...
                           while($s1=mysqli_fetch_array($sql1))
                           {
                            if ($s1['alatbayar_nama']!='TUNAI'){
                              ...
                              $tot_dasar_fee=$tot_dasar_fee+round($dasar_fee,2);
                              ...
                              <tr align="left">
                                ...
                                <td align="right"><?php echo number_format($s1['subjumlah']); ?></td>
                                <td align="right"><?php echo $s1['acuan_fee']; ?></td>
                                <td align="right"><?php echo number_format($s1['tarif_fee'],2); ?></td>
                                <td align="right"><?php echo number_format($s1['dasar_fee']); ?></td>
                        ...
                        <table id="example" class="table table-bordered table-striped" style="width:600px">
                          ...
                          <tbody>
                            ...
                            // if ($s1['alatbayar_nama']!='TUNAI'){
                              ...
                              <tr align="left">
                                <td><?php echo $s1['jt_nama']; ?></td>
                                <td align="right"><?php echo number_format($s1['tot_dasar_fee']); ?></td>
                              </tr>
                              <?php
                              $no++;
