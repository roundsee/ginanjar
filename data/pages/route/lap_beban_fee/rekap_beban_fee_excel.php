...
<table border="1" cellspacing="1" >
	<thead >
		<tr>
			...
			<th style="width:160px ;padding-bottom:1px;">Acuan<br>Fee</th>
		...
		while($s1=mysqli_fetch_array($sql1))
		{
			if ($s1['alatbayar_nama']!='TUNAI'){
				...
				<tr align="left">
					...
					<td align="right"><?php echo ($s1['rekap_subjumlah']); ?></td>
					<td align="right"><?php echo $s1['acuan_fee']; ?></td>
					<td align="right"><?php echo ($s1['tarif_fee']); ?></td>
					<td align="right"><?php echo ($s1['rekap_dasar_fee']); ?></td>
	...
	<tfoot>
		<td colspan="10" align="right">TOTAL Fee Penjualan</td>
		<td style="text-align: right;"><?php echo ($tot_rekap_dasar_fee);?></td>
