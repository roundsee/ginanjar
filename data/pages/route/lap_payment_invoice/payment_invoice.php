                                                    ...
                                                    <table id="example1" class="table table-bordered table-striped">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            $sql1 = mysqli_query($koneksi, "SELECT 
                                                                pyd.$f1, 
                                                                pyd.$f2, 
                                                        GROUP_CONCAT(DISTINCT p.jumlah_payment) AS jumlah_payment, 
                                                              SUM(pyd.$f5) as total_jumlah_datang,
                                                                SUM(DISTINCT pyd.$f5 * pyd.$f6 - pyd.disc)  AS total_harga,
                                                            ...
                                                            LEFT JOIN barang b ON b.kd_brg = pyd.kd_brg
                                                            WHERE status  < 2
                                                            GROUP BY pyd.no_payment,p.jumlah_payment, pyd.$f2 ");
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            $.each(response, function(index, item) {
                                ...
                                var perhitunganPpn = (ppn == 1) ? (itemTagihan * 0.11) : 0;
                                console.log("perhitungan ppn " + perhitunganPpn);
