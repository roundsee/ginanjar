...
?>
                            ...
                            <tbody>
                              ...
                              ?>
                                <tr align="middle">
                                  ...
                                  <td><?php echo $j[$f2]; ?> </td> 
                                  <td><?php echo $j[$f3]; ?> </td> 
                                  <td><a href="main.php?route=gudang&act=edit&ids=<?php echo $j[$f1]; ?>&asal=<?php echo $_GET['asal']; ?>" title="Edit Data"><button class="btn btn-primary btn-sm elevation-2" style="opacity: .7;width:80px"><i class="fa fa-edit"></i> Edit</button></a>

                                    <a href="route/data_gudang/aksi_gudang.php?route=gudang&act=hapus&id=<?php echo $j[$f1]; ?>" title="Hapus Data" onclick="return confirm('Apakah anda yakin ingin menghapus ini ?')"><button class="btn btn-danger btn-sm elevation-2" style="opacity: .7;width:80px"><i class="fa fa-trash"></i> Hapus</button></a>
                                  </td>
                                </tr>
                              <?php
                              }
    ...
    case "edit":
      ...
      //edit
      $ubah = mysqli_query($koneksi, "SELECT * FROM gudang WHERE id_gudang  = '$_GET[ids]'");
