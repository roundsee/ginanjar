...
$judulform="Payment POS Detail B";
...
if (empty($_SESSION['username']) AND empty($_SESSION['passuser'])){
  ...
  switch($_GET['act']){
    ...
    $judul='Laporan Payment POS Detail B';
    ...
    <div class="content-wrapper" style="background-color: beige; max-height: 1400px!important;">
      ...
      <section class="content-header  wow fadeInDown" data-wow-duration=".3s" data-wow-delay=".3s" >
        <div class="container-fluid">
          ...
          <button class="btn btn-primary btn-sm elevation-2 " style="opacity: .7;" onclick="window.location='route/<?php echo $data;?>/cetak2b.php?tgl_awal=<?php echo $tgl_awal;?>&tgl_akhir=<?php echo $tgl_akhir;?>&filter=<?php echo $filter;?>&nilai=<?php echo $nilai;?>&judul=<?php echo $judul;?>'"><img src="../../assets/icons/print.png" width="20px"> print </button>

          <button class="btn btn-primary btn-sm elevation-2 " style="opacity: .7;" onclick="window.location='route/<?php echo $data;?>/lap_pos2b_excel.php?tgl_awal=<?php echo $tgl_awal;?>&tgl_akhir=<?php echo $tgl_akhir;?>&filter=<?php echo $filter;?>&nilai=<?php echo $nilai;?>&judul=<?php echo $judul;?>'"><img src="../../assets/icons/excel2.png" width="20px"> export </button>
                      ...
                      <div class="table-responsive">
                        ...
                        <table id="example" class="table table-bordered table-striped">
                          <thead style="background-color:  lightgray;" class="elevation-2">
                            <tr>
                              ...
                              <th style="text-align: right">Jumlah(Sub Jumlah + Pb1)</th>
                            </tr>
                          </thead>
                          <tbody>
                           <?php
                           ...
                           while($s1=mysqli_fetch_array($sql1))
                           {
                            ...
                            <tr align="left">
                              ...
                              <td style="text-align: right;"><?php echo number_format($s1['jd_diskon']);?></td>
                              <td style="text-align: right;"><?php echo number_format($tot_subjumlah);?></td>
                              <td style="text-align: right;"><?php echo number_format($tot_pb1);?></td>
                        ...
                        <tfoot>
                          <tr style="font-weight:800">
                            ...
                            <td align="right"><?php echo number_format($grand_subjumlah);?></td>
                            <td align="right"><?php echo number_format($grand_pb1);?></td>
                            <td align="right"><?php echo number_format($grand_jumlah);?></td>
                          </tr>
                        </tfoot>
