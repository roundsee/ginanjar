...
if (empty($_SESSION['username']) AND empty($_SESSION['passuser'])){
  ...
  switch($_GET['act']){
    ...
    $judul='Laporan Payment POS Detail';
    ...
    <div class="content-wrapper" style="background-color: beige; max-height: 1400px!important;">
      ...
      <section class="content-header  wow fadeInDown" data-wow-duration=".3s" data-wow-delay=".3s" >
        <div class="container-fluid">
          ...
          <button class="btn btn-primary btn-sm elevation-2 " style="opacity: .7;" onclick="window.location='route/<?php echo $data;?>/cetak2.php?tgl_awal=<?php echo $tgl_awal;?>&tgl_akhir=<?php echo $tgl_akhir;?>&filter=<?php echo $filter;?>&nilai=<?php echo $nilai;?>&judul=<?php echo $judul;?>'"><img src="../../assets/icons/print.png" width="20px"> print </button>
                    ...
                    <div class="box-body">
                      <div class="table-responsive">
                        ...
                        <table id="example" class="table table-bordered table-striped">
                          ...
                          <tbody>
                           <?php
                           $query="SELECT penjualan.subjumlah,penjualan.tarif_pb1,penjualan.jumlah,penjualan.faktur,penjualan.oleh,penjualan.tanggal, pelanggan.nama as p_nama,
                           ...
                           while($s1=mysqli_fetch_array($sql1))
                           {
                            ...
                            <tr align="left">
                              ...
                              <td style="text-align: right;"><?php echo number_format($s1['jd_jumlah']);?></td>
