...
<?php if ($login_hash == 6 or $login_hash == 7 or $filter == 'outlet') { ?>
	...
	<table id="example" class="table table-bordered table-striped">
		...
		<tbody>
			...
			$query = "SELECT batal_penjualan.faktur,batal_penjualan.tanggal,batal_penjualan.oleh,batal_penjualan.no_ref,batal_penjualan.alasan,
				pelanggan.nama as p_nama,
				batal_penjualan.jumlah as p_jumlah,
				kotabaru.nama as kb_nama ,
				jenis_transaksi.nama as jt_nama
				FROM batal_penjualan 
				join pelanggan on pelanggan.kd_cus=batal_penjualan.kd_cus
...
<?php } elseif ($filter == 'kota') { ?>
	...
	<table id="example" class="table table-bordered table-striped">
		...
		<tbody>
			...
			$query = "SELECT batal_penjualan.faktur,batal_penjualan.tanggal,batal_penjualan.oleh,batal_penjualan.no_ref,batal_penjualan.alasan,
					pelanggan.nama as p_nama,
					sum(batal_penjualan.jumlah) as p_jumlah,
					kotabaru.nama as kb_nama ,
					jenis_transaksi.nama as jt_nama
					FROM batal_penjualan 
					join pelanggan on pelanggan.kd_cus=batal_penjualan.kd_cus
