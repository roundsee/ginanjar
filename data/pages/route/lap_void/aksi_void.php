...
$act=$_GET['act'];
	...
	//Hapus area
if($route=='void_pos' AND $act=='proses1')
{
...
}elseif($route=='void_pos' AND $act=='proses2b')
{
...
elseif($route=='void_pos' AND $act=='hapuskota')
{
...
elseif($route=='void_pos' AND $act=='save')
{
...
elseif($route=='void_pos' AND $act=='report')
{
...
elseif($route=='void_pos' AND $act=='report_void_pos1')
{
	...
	if(($login_hash=='6' OR $login_hash=='7' OR $login_hash=='8') AND $selisihtgl>=7){
		...
		header('location:../../route/lap_void/lap_void_pos1.php?filter='.$filter.'&nilai='.$nilai.'&tgl_awal='.$tgl_awal.'&tgl_akhir='.$tgl_akhir);
	}
...
elseif($route=='void_pos' AND $act=='report_void_pos2')
{
	...
	if(($login_hash=='6' OR $login_hash=='7' OR $login_hash=='8') AND $selisihtgl>=7){
		...
		header('location:../../route/lap_void/lap_void_pos2.php?filter='.$filter.'&nilai='.$nilai.'&tgl_awal='.$tgl_awal.'&tgl_akhir='.$tgl_akhir);
	}
