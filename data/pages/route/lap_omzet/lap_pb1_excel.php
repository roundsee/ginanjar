...
header("Content-Disposition: attachment; filename=Laporan-Detail-Transsaksi.xls");//ganti nama sesuai keperluan
...
<body>
	...
	<!-- <div class="container"> -->
		...
		<br><center>Laporan Omset dan PB1
			<br><?php echo $filter." : ".$judul_nilai;?>
			<br>Periode : <?php echo $tgl_awal." s/d ".$tgl_akhir;?></center> 
		</div><!-- /.container-fluid -->
	</section>
	<table id="example" class="table table-bordered table-striped">
		...
		<tfoot>
			<tr style="font-weight:800">
				...
				<td><?php echo ($tot_subjumlah);?></td>
				<td><?php echo ($tot_ppn);?></td>
	...
	<table style="background-color:beige;font-weight:700">
		<tr>
			<td colspan="3" style="width:200px"> Total</td>
			<td style="width:30px">:</td>
			<td colspan="2" style="text-align:right;"><?php echo ($tot_subjumlah);?></td>
		</tr>
		<tr>
			<td colspan="3" > Total PB1</td>
			<td>:</td>
			<td colspan="2" style="text-align:right;"><?php echo ($tot_ppn);?></td>
		</tr>

		<tr>
			<td colspan="3"> Total setelah Pajak</td>
			<td>:</td>
			<td colspan="2" style="text-align:right;"><?php echo ($tot_jumlah);?></td>
		</tr>
		...
		<tr>
			<td colspan="3">Total OFF Line </td>
			<td>:</td>
			<td colspan="2"><?php echo $tot_ofline;?></td>
		</tr>
		<tr>
			<td colspan="3">Total ON Line </td>
			<td>:</td>
			<td colspan="2"><?php echo $tot_online;?></td>
		</tr>
		<tr>
			<td colspan="6">.</td>
		</tr>
		<tr>
			<td colspan="3">Total Dine In</td>
			<td>:</td>
			<td colspan="2"><?php echo $tot_11;?></td>
		</tr>
		<tr>
			<td colspan="3">Total Aplikasi Shoppe</td>
			<td>:</td>
			<td colspan="2"><?php echo $tot_22;?></td>
		</tr>
		<tr>
			<td colspan="3">Total Aplikasi Grab</td>
			<td>:</td>
			<td colspan="2"><?php echo $tot_33;?></td>
		</tr>
		<tr>
			<td colspan="3">Total Aplikasi GoJek</td>
			<td>:</td>
			<td colspan="2"><?php echo $tot_44;?></td>
		</tr>
