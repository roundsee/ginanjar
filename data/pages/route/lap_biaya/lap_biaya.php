                              ...
                              <div class="col-lg-2">
                                ...
                                <div class="form-group">
                                  ...
                                  <?php if ($login_hash != '8') { ?>
                                    ...
                                    <div>
                                      <input type="radio" name="cakup" onclick="displayResult(this.value)" value="Supplier"> Jenis Biaya
                                    </div>
                                    <!-- <div>
                                          ...
                                          <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                              <button style="margin-top: 27px" type="button" class="btn btn-primary btn-sm btn-block" data-toggle="modal" data-target="#cariAsuransi">
                                                <i class="fa fa-search"></i> Cari Jenis Biaya
                                              </button>
                                            </div>
                                          </div>

                                          <label>Biaya<span id="status_asuransi"></span></label>
                                          <input type="text" class="form-control" name="supplier" value="" required="required" placeholder="Jenis Biaya .." id="tampil_asuransi_nama" readonly>
                                                  ...
                                                  <table class="table table-bordered table-striped table-hover" id="table-datatable-kota">
                                                    ...
                                                    <tbody>
                                                      ...
                                                      $jenis_biaya = [
                                                        ...
                                                        "PDAM" => "PDAM",
                                                        "ATK" => "ATK",
                                                        "Bensin Parkir" => "Bensin Parkir",
                                                        "Pembungkus" => "Pembungkus",
                                                        "Iuran dan Sumbangan" => "Iuran dan Sumbangan",
                                                        "Pemeliharaan Gedung" => "Pemeliharaan Gedung",
                                                        "Biaya Lain-lain" => "Biaya Lain-lain"
                                                      ];
                                                      $no = 1;
                                                      foreach ($jenis_biaya as $kode => $nama) {
                                                      ?>
                                                        <tr>
                                                          <td width="1%" class="text-center"><?php echo $no++; ?></td>
                                                          <td><?php echo $nama; ?></td>
                                                          <td width="1%">
                                                            <button type="button" class="btn btn-success btn-sm modal-pilih-asuransi" id="<?php echo $kode; ?>" kode="<?php echo $kode; ?>" nama="<?php echo $nama; ?>" data-dismiss="modal">Pilih</button>
                                                          </td>
                                                        </tr>
                                                      <?php
                                                      }
