  ...
  <table id="example4" class="table table-bordered table-striped">
    ...
    <tbody>
      ...
      ?>
        <tr align="left">
          ...
          <td align="right"><?php echo number_format($data['sisa'], 2); ?></td>
          <td align="right" style="background-color: #e0f7fa;"><?php echo number_format($data['range_1_7'], 2); ?></td>
          <td align="right" style="background-color: #ffe0b2;"><?php echo number_format($data['range_8_14'], 2); ?></td>
          <td align="right" style="background-color: #c8e6c9;"><?php echo number_format($data['range_15_21'], 2); ?></td>
          <td align="right" style="background-color: #ffcdd2;"><?php echo number_format($data['range_22_plus'], 2); ?></td>
        </tr>
      <?php
        $no++;
      }
    ...
    <tfoot>
      <tr style="font-weight: bold; background-color: #D6D6D6;">
        ...
        <td style="background-color: #e0f7fa; text-align:right;" ><?php echo number_format($grandTotal['range_1_7'], 2); ?></td>
        <td style="background-color: #ffe0b2; text-align:right;" ><?php echo number_format($grandTotal['range_8_14'], 2); ?></td>
        <td style="background-color: #c8e6c9; text-align:right;" ><?php echo number_format($grandTotal['range_15_21'], 2); ?></td>
        <td style="background-color: #ffcdd2; text-align:right;" ><?php echo number_format($grandTotal['range_22_plus'], 2); ?></td>
      </tr>
    </tfoot>
  </table>
