                                    ...
                                    <div class="box">
                                        <div class="box-body">
                                            ...
                                            <div class="wrapper" style="min-height:30%">
                                                <form role="form" action="route/<?php echo $data; ?>/<?php echo $aksi; ?>.php?route=<?php echo $rute; ?>&act=report-detail" method="post">
                                                    <div class="row">
                                                        <!-- Batas -------------- -->
                                                            ...
                                                            ");
                                                                ...
                                                                ?>
                                                                    <tr align="left">
                                                                        ...
                                                                        <td><?php echo number_format($hargatotal, 2); ?></td>
                                                                        <td>
                                                                            <a href="main.php?route=<?php echo $view; ?>&act&id=<?php echo $s1['no_invoice']; ?>&asal=<?php echo $rute; ?>" title="Detail" style="text-decoration: none;">
                                                                        ...
                                                                        <td style="background-color: #e0f7fa;"><?php echo number_format(($selisih_hari >= 0 && $selisih_hari <= 7) ? $sisa_tagihan : 0, 2); ?></td>
                                                                        <td style="background-color: #ffe0b2;"><?php echo number_format(($selisih_hari >= 8 && $selisih_hari <= 14) ? $sisa_tagihan : 0, 2); ?></td>
                                                                        <td style="background-color: #c8e6c9;"><?php echo number_format(($selisih_hari >= 15 && $selisih_hari <= 21) ? $sisa_tagihan : 0, 2); ?></td>
                                                                        <td style="background-color: #ffcdd2;"><?php echo number_format(($selisih_hari > 21) ? $sisa_tagihan : 0, 2); ?></td>
                                                                    </tr>
                                                                <?php
                                                                    $no++;
                                                                }
