    ...
    <div class="box">
        ...
        <?php if ($filter == 'outlet' or $login_hash == '6' or $login_hash == '7' or $login_hash == '2') { ?>
            ...
            <div class="box-body">
              ...
              ";
                            ...
                            $query = "SELECT barang.nama as brg_nama, sum(jualdetil.banyak) as rekap_jualdetil_banyak, sum(jualdetil.jumlah) as rekap_jualdetil_jumlah,sum(jualdetil.diskon) as discount
              FROM jualdetil 
              ...
              HAVING sum(jualdetil.banyak) <> 0 AND sum(jualdetil.jumlah) <> 0";
        ...
        <?php if ($filter == 'semua') { ?>
            ...
            <div class="box-body">
              ...
              sum(penjualan.ppn) as rekap_ppn, 
              sum(penjualan.byr_pocer) as rekap_pocer,
              sum(penjualan.subjumlah_offline) as rekap_subjumlah
              FROM penjualan 
              join jenis_transaksi on jenis_transaksi.kd_jenis=penjualan.kd_aplikasi 
              join alat_bayar on alat_bayar.kd_alat=penjualan.kd_alatbayar 
              ...
              ";
                            ...
                            <tr>
                                <td colspan="3">Total Sub Jumlah </td>
                                <td colspan="2" align="right"><?php echo number_format($grand_subpenjualan); ?></td>
                            </tr>
