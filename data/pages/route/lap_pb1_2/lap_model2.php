				...
				<tbody>
					...
					while($s1=mysqli_fetch_array($sql1))
					{
						...
						<tr align="left">
							...
							<td width="130px"><?php echo $s1['p_nama']; ?></td>
							<!-- <td><?php echo $s1['kd_kota']; ?></td> -->
							<td width="100px"><?php echo $s1['kb_nama']; ?></td>
							<td width="130px"><?php echo $s1[$f2]; ?></td>
							<td width="130px"><?php echo $s1[$f1]; ?></td>
