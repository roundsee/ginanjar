	...
	<!-- <link rel="stylesheet"  href="https://cdn.datatables.net/1.10.24/css/jquery.dataTables.min.css">
		...
		<table id="example" class="table table-bordered table-striped" >
			...
			<tbody>
				...
				while($s1=mysqli_fetch_array($sql1))
				{
					...
					<tr align="left">
						...
						<td style="text-align: right;"><?php echo ($s1[$f7]/10);?></td>
						<td style="text-align: right;"><?php echo ($s1[$f7]*1.1);?></td>
			...
			<tfoot>
				<tr style="font-weight:800">
					...
					<td><?php echo ($tot_subjumlah*0.1);?></td>
					<td><?php echo ($tot_subjumlah*1.1);?></td>
		...
		<table id="example" class="table table-bordered table-striped" style="width:600px">
			...
			<tbody>
				...
				while($s1=mysqli_fetch_array($sql1))
				{
					...
					<tr>
						...
						<td align="right"><?php echo ($s1['count_jumlah']);?></td>
						<td align="right"><?php echo ($s1['pj_subjumlah']);?></td>
						<td align="right"><?php echo ($s1['pj_subjumlah']*0.1);?></td>
						<td align="right"><?php echo ($s1['pj_subjumlah']*1.1);?></td>

						<!-- <td align="right"><?php echo ($s1['pj_ppn']);?></td>
						<td align="right"><?php echo ($s1['pj_jumlah']);?></td> -->
					</tr>
			...
			<tr>
				...
				<td align="right"><?php echo ($tot_line);?></td>
				<td align="right"><?php echo ($tot_rekap_subjumlah);?></td>
				<td align="right"><?php echo ($tot_rekap_subjumlah*0.1);?></td>
				<td align="right"><?php echo ($tot_rekap_subjumlah*1.1);?></td>

				<!-- <td align="right"><?php echo ($tot_rekap_ppn);?></td>
