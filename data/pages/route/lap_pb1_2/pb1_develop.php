                            ...
                            <table id="example" class="table table-bordered table-striped">
                              ...
                              <tbody>
                               ...
                               while($s1=mysqli_fetch_array($sql1))
                               {
                                ...
                                $m_no[]=$no;
                                $m_p_nama[]=$s1['p_nama'];
                                $m_kb_nama[]=$s1['kb_nama'];
                                $m_tanggal[]=$s1['tanggal'];
                                $m_ket_aplikasi[]=$s1['ket_aplikasi'];
                                $m_kd_aplikasi[]=$s1['kd_aplikasi'];
                                $m_jt_nama[]=$s1['jt_nama'];
                                $m_subjumlah[]=$s1['subjumlah'];
                                $m_ppn[]=$s1['ppn'];
                        ...
                        <table id="example" class="table table-bordered table-striped">
                          ...
                          <tbody>
                            ...
                            for ($i=0; $i < $pjg_data; $i++) { 
                              ...
                              <tr>
                                <td><?php echo $i+1;?></td>
                                <td><?php echo $m_p_nama[$i];?></td>
                                <td><?php echo $m_kb_nama[$i];?></td>
                                <td><?php echo $m_tanggal[$i];?></td>
                                <td><?php echo $m_kd_aplikasi[$i];?></td>
                                <td style="text-align:right;"><?php echo number_format($m_ppn[$i]);?></td>
