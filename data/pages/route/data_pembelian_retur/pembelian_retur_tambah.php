...
$judulform = "Purchae Return Tambah";
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6 col-lg-4">
                        <div class="form-group">
                          ...
                          <input type="date" name="<?php echo $f2; ?>" class="form-control" placeholder="Masukan <?php echo $j2; ?> ..." required="required" value="<?php echo date('Y-m-d');  ?>" />
                        </div>
                      </div>
                      ...
                      <div class="col-md-6 col-lg-4">
                        <div class="form-group">
                          ...
                          <select name="<?php echo $f7; ?>" id="" class="form-control">
