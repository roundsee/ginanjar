...
<div class="row table-responsive" style="height: 75%;width:100%;overflow-x: hidden;">
        ...
        ?>
          <div class="filtr-item col-lg-12" style="padding-left: 15px;padding-right: 1px;padding-top: 1px;">
            <div class="menupilihan">
              ...
              <input type="hidden" id="satuan_<?php echo $d['kd_brg']; ?>" value="<?php echo $d['Satuan1']; ?>">
              <input type="hidden" id="satuan_awal_<?php echo $d['kd_brg']; ?>" value="<?php echo $d['Satuan1']; ?>">
              ...
              <a class="modal-pilih-produk" id="<?php echo $d['kd_brg']; ?>" data-dismiss="modal">
                ...
                <span class="menunama2 ">
                  <?php echo 'Stock Barang : ' . $d['Quantity']; ?>
                </span>
